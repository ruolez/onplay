...
export const professionalThemes: Record<string, ThemeConfig> = {
  slate: {
    ...
    cardBorderHover: "rgba(139, 92, 246, 0.4)",
    cardShadow: "none",
    cardShadowHover: "0 0 0 1px rgba(139, 92, 246, 0.3)",
    ...
    playerBarBg: "rgba(10, 10, 10, 0.95)",
  ...
  midnight: {
    ...
    cardBgHover: "rgba(48, 54, 61, 0.7)",
    cardBorder: "rgba(48, 54, 61, 0.6)",
    cardBorderHover: "rgba(83, 155, 245, 0.5)",
    cardShadow: "none",
    cardShadowHover: "0 0 0 1px rgba(83, 155, 245, 0.4)",
    cardOverlay: "rgba(0, 0, 0, 0.4)",
    btnPrimaryBg: "#539bf5",
    btnPrimaryText: "#ffffff",
    ...
    playerProgressBg: "rgba(48, 54, 61, 0.4)",
    iconAudio: "#a371f7",
    iconVideo: "#539bf5",
  },
  ...
  charcoal: {
    ...
    cardBorderHover: "rgba(0, 112, 243, 0.5)",
    cardShadow: "none",
    cardShadowHover: "0 0 0 1px rgba(0, 112, 243, 0.4)",
    ...
    playerBarButtonHover: "rgba(255, 255, 255, 0.08)",
    playerProgressBg: "rgba(255, 255, 255, 0.15)",
    iconAudio: "#50e3c2",
    iconVideo: "#0070f3",
  },
  ...
  graphite: {
    ...
    accentHover: "#9feaf9",
    cardBg: "rgba(26, 31, 38, 0.7)",
    cardBgHover: "rgba(42, 47, 56, 0.85)",
    cardBorder: "rgba(94, 109, 130, 0.3)",
    cardBorderHover: "rgba(127, 219, 202, 0.4)",
    cardShadow: "none",
    cardShadowHover: "0 0 0 1px rgba(127, 219, 202, 0.35)",
    cardOverlay: "rgba(0, 0, 0, 0.4)",
    btnPrimaryBg: "#7fdbca",
  ...
  onyx: {
    ...
    cardShadow: "none",
    cardShadowHover: "0 0 0 1px rgba(255, 255, 255, 0.25)",
    cardOverlay: "rgba(0, 0, 0, 0.5)",
    btnPrimaryBg: "#ffffff",
  ...
  steel: {
    ...
    cardShadow: "none",
    cardShadowHover: "0 0 0 1px rgba(56, 189, 248, 0.35)",
    cardOverlay: "rgba(0, 0, 0, 0.4)",
    btnPrimaryBg: "#38bdf8",
  ...
  eclipse: {
    bgPrimary: "#0d0e12",
    bgGradient: "linear-gradient(180deg, #0d0e12 0%, #14151b 100%)",
    navBg: "rgba(13, 14, 18, 0.9)",
    navBorder: "rgba(113, 113, 122, 0.2)",
    navShadow: "none",
    dropdownBg: "rgba(13, 14, 18, 0.95)",
    textPrimary: "#f4f4f5",
    textSecondary: "#a1a1aa",
    textMuted: "#71717a",
    accentPrimary: "#9ca3b8",
    accentSecondary: "#c5cbd9",
    accentHover: "#c5cbd9",
    cardBg: "rgba(45, 47, 58, 0.6)",
    cardBgHover: "rgba(45, 47, 58, 0.8)",
    cardBorder: "rgba(113, 113, 122, 0.25)",
    cardBorderHover: "rgba(156, 163, 184, 0.4)",
    cardShadow: "none",
    cardShadowHover: "0 0 0 1px rgba(156, 163, 184, 0.3)",
    cardOverlay: "rgba(0, 0, 0, 0.4)",
    btnPrimaryBg: "#fafafa",
    ...
    playerBarBg: "rgba(13, 14, 18, 0.95)",
