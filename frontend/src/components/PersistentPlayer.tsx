...
export default function PersistentPlayer() {
  ...
  return (
    <>
      ...
      >
        {/* Main Controls - Three Column Layout (Spotify/YouTube style) */}
        <div className="px-2 sm:px-4 py-2 sm:py-3 flex items-center gap-2 sm:gap-4">
          {/* LEFT COLUMN: Metadata (flex-1, left-aligned) */}
          ...
          {/* CENTER COLUMN: Playback Controls (auto width, centered) */}
          ...
          {/* RIGHT COLUMN: Secondary Controls (flex-1, right-aligned) */}
          <div className="flex items-center gap-2 sm:gap-3 flex-1 justify-end">
            ...
            {/* Wake Lock Toggle - Prominent position after queue counter */}
            <button
            ...
            <button
              onClick={toggleMute}
              className="hidden md:flex p-3 rounded-full transition-colors theme-text-primary"
              onMouseEnter={(e) =>
                (e.currentTarget.style.background =
                  "var(--player-bar-button-hover)")
              }
            ...
            <input
              ...
              className="hidden md:block w-20 h-1 rounded-lg appearance-none cursor-pointer"
              style={{
